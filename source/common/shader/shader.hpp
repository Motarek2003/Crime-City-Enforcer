...
namespace our {
    ...
    public:
        ...
        // Answer: We delete the copy constructor and assignment operator to prevent copying of the ShaderProgram object,
        // which could lead to multiple deletions of the same OpenGL program resource when the objects go out of scope.
    };
